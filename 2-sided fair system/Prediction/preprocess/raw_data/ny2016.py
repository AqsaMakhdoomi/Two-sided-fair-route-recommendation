...
if __name__ == '__main__':
    ...
    parser.add_argument('-sd', '--startDate', type=str, default='2016-02-01',
                        help='The start date to filter (inclusive), default={}'.format('2016-02-01'))
    parser.add_argument('-ed', '--endDate', type=str, default='2016-02-28',
                        help='The end date to filter (exclusive), default={}'.format('2016-02-28'))
